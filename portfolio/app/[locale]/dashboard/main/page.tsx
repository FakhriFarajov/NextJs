        ...
        <SidebarProvider>
            ...
            <SidebarInset>
                ...
                <header className="flex h-16 shrink-0 items-center gap-2 px-4 transition-[width,height] ease-linear group-has-[[data-collapsible=icon]]/sidebar-wrapper:h-12">
                    ...
                    <h1 className="text-sm font-semibold text-muted-foreground">Overview</h1>
                </header>
                ...
                <div className="flex flex-1 flex-col gap-6 p-6 pt-0">
                    ...
                    <div className="grid gap-4 md:grid-cols-3">
                        ...
                        <div className="group relative overflow-hidden rounded-xl border bg-card p-6 shadow-sm transition-all hover:shadow-md">
                            ...
                            <div className="mt-4 flex items-center text-xs text-muted-foreground">
                                <span>Based on 128 responses</span>
                            </div>
                        </div>
                    ...
                    <div className="flex-1 rounded-xl border bg-card shadow-sm overflow-hidden">
                        <div className="border-b p-6">
                            <h2 className="text-lg font-semibold tracking-tight">Recent Project Activity</h2>
                            <p className="text-sm text-muted-foreground">A detailed look at your latest portfolio additions.</p>
                        </div>
                        <div className="p-6">
                               ...
                               {[1, 2, 3].map((i) => (
                                   <div key={i} className="flex items-center justify-between rounded-lg border p-4 transition-colors hover:bg-muted/50">
                                       <div className="flex items-center gap-4">
                                           ...
                                           <div>
                                               <p className="font-medium text-sm">Project Title Alpha {i}</p>
